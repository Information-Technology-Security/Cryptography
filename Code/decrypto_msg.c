...
int main(int argc, char *argv[])
{
    ...
    /*
     *  Initialization of the modulo N computed in 
     *  Activity 1: Private key generation
     */
    ...
    /*
     *  Initialization of the encrypted message C  
     */
    BN_hex2bn(&C, "7074A77B724869F59EBA8B790CEAA6A33B2E268A00BAF124BA7C3A6BDE690F36");
